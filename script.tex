...
\begin{figure}
\subfigure[surjektive Abbildung]{\includegraphics[width=3cm]{Surjection.png}}\hfill
\subfigure[injektive Abbildung]{\includegraphics[width=3cm]{Injection.png}}\hfill
\subfigure[bijektive Abbildungen]{\includegraphics[width=3cm]{Bijection.png}}\hfill
\subfigure[identische Abbildungen]{\includegraphics[width=3cm]{Identitaet.png}}
\end{figure}
