...
\usepackage{lmodern} % Modernere Version der Standard-Schriftart
...
\else
  \ifLuaTeX
  % LuaLatex ist die Weiterentwicklung von pdflatex
  % Vorteile:
  % - kann natives utf-8
  % - Macros sind auch in der schönen Sprache Lua scriptbar
  % - Unterstützung vom auf dem Betriebssystem installierten Fonts
  % braucht auf meinem Computer mehr CPU.
  % zum Ausprobieren ganz witzig.
...
\newpage
\input{03-graphen/03.2-binaere_relate.tex}
\newpage
\input{03-graphen/03.3-morphismen.tex}

\newpage
\section{Teilbarkeit}
\input{04-teilbarkeit.tex}

\newpage
\section{Multimengen}
\input{05-multimengen.tex}
