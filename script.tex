...
\begin{figure}
\subfigure[surjektive Abbildung]{\includegraphics[width=4cm]{images/Surjection.png}}\hfill
\subfigure[injektive Abbildung]{\includegraphics[width=4cm]{images/Injection.png}}\hfill
\subfigure[bijektive Abbildungen]{\includegraphics[width=4cm]{images/Bijection.png}}
\end{figure}
